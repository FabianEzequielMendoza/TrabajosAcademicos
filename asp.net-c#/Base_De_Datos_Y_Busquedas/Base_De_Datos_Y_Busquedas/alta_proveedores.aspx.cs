...
namespace Base_De_Datos_Y_Busquedas
{
    public partial class alta_proveedores : System.Web.UI.Page
    {
        ...
        {
            string query = @"INSERT INTO proveedores (razonSocial,CUIT,activo,fechaCreacion)
            ...
            try
            {
                ...
                else
                {
                    try
                    {
                        ...
                        command.Parameters.AddWithValue("TB4", DateTime.Now);// PARAMETRO SI LA CONSULTA LO TIENE
